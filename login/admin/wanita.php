...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Jadwal Ibadah Wanita</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
        ...
        <div class="card-body">
                      <table id="dataTables" class="table table-bordered table-striped" >
                          ...
                          <tbody>
                            ...
                            $no = 1;
                            $res = $conn->query("select * from wanita");
                            while($row = $res->fetch_assoc()){
                              ...
                              <tr>
                                ...
                                <td>'.$row['khotbah'].'</td>
                                <td>
                                 <a href ="editwanita.php?id='.$row['id'].'"><i class="btn btn-primary ">edit</i></a>
                                 <a href ="hapuswanita.php?id='.$row['id'].'"><i class="btn btn-danger ">hapus</i></a>
                                </td>
                              </tr>
                              ';
                              $no++;
