    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <?php
                ...
                $id = $_GET['id'];
                $data = mysqli_query($koneksi,"select * from minggu where id='$id'");
        ...
        <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <label>Pujian</label>
                    <input type="text" class="form-control" id="pujian" name="pujian" value="<?php echo $d ['pujian'] ?>" placeholder="Pujian">
                  </div>
                  <div class="form-group">
                    <label>Pemusik</label>
            ...
            <?php 
                 if(isset($_POST['simpan'])){
                    if(editminggu ($_POST) > 0){
                        echo " 
                             <script>
                                document.location.href = 'minggu.php?r=update';
                            </script>";
                            }else{
                                echo " 
                                    <script>
