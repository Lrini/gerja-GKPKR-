...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Jadwal Pelayan Wanita</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <?php
                ...
                $id = $_GET['id'];
                $data = mysqli_query($koneksi,"select * from wanita where id='$id'");
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <?php 
                 if(isset($_POST['simpan'])){
                    if(editwanita ($_POST) > 0){
                        echo " 
                             <script>
                                document.location.href = 'wanita.php?r=update';
                            </script>";
                            }else{
                                echo " 
                                    <script>
